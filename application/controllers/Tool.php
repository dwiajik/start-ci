...
class Tool extends CI_Controller
{
    ...
    public function help() {
        ...
        $result .= "php index.php tool migration \"file_name\"         Create new migration file\n";
        $result .= "php index.php tool migrate [\"version_number\"]    Run all migrations. The version number is optional.\n";
        $result .= "php index.php tool seeder \"file_name\"            Creates a new seed file.\n";
        $result .= "php index.php tool seed \"file_name\"              Run the specified seed file.\n";
